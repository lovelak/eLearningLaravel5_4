...
--
-- Host: localhost:3306
-- Generation Time: May 11, 2018 at 04:35 PM
...
(11, '2018_05_10_225113_create_results_table', 5),
...
(4, '<p>test</p>', 'e', 'e', 'e', 'e', '1', NULL, '2018-05-10 07:07:49', '2018-05-10 07:07:49'),
(5, '<p>fdf</p>', 'fdf', 'fdf', 'fd', 'df', '1', NULL, '2018-05-10 08:08:47', '2018-05-10 08:08:47');
...
CREATE TABLE `results` (
  ...
  `pretest_id` int(10) unsigned DEFAULT NULL,
  `user_id` int(10) unsigned DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
INSERT INTO `submenu` (`id`, `name`, `description`, `menu_id`, `created_at`, `updated_at`) VALUES
(5, 'ข้อมูลส่วนตัว', NULL, 3, '2018-05-11 08:51:10', '2018-05-11 08:51:10'),
(6, 'ข้อมูลการมาปฏิบัติราชการ', NULL, 3, '2018-05-11 08:51:23', '2018-05-11 08:51:23'),
(7, 'ข้อมูลการรักษาวินัย', NULL, 3, '2018-05-11 08:51:32', '2018-05-11 08:51:32'),
(8, 'สรุปผลการปฏิบัติงานโดยย่อ', NULL, 3, '2018-05-11 08:51:41', '2018-05-11 08:51:41'),
(9, 'การพัฒนาตนเอง', NULL, 3, '2018-05-11 08:52:04', '2018-05-11 08:52:04'),
(10, 'เกียรติบัตร', NULL, 3, '2018-05-11 08:52:14', '2018-05-11 08:52:14');
...
ALTER TABLE `results`
  ADD PRIMARY KEY (`id`),
  ADD KEY `results_pretest_id_foreign` (`pretest_id`),
...
ALTER TABLE `results`
  ...
  ADD CONSTRAINT `results_pretest_id_foreign` FOREIGN KEY (`pretest_id`) REFERENCES `pretests` (`id`);
